(function($) {
  class DcCustomSelect {
    ...
    createSelectUi(el) {
        let that = this,
            { placeholder, search, searchPlaceholder, notFoundContent, baronScrollInit, btnReset } = this.options,
            dropdownList = "",
            btnResetElement = "";
        ...
        el.append(`
            <div class="_dc_customSelect__select">
                <div class="_dc_customSelect__select_text">${placeholder !== undefined ? placeholder : el.find("select").attr("data-placeholder")}</div>
    ...
    bindFunctionOnUi() {
        ...
        parent.find("._dc_customSelect__list_item").on("click", function() {
            ...
            that.updatePlaceholder(parent.find("._dc_customSelect__list_item.active").text());
            that.closeDropdown();
        });

        //событие для сброса значения
        if (parent.find("._dc_customSelect__btnReset") && btnReset) {
            parent.find("._dc_customSelect__btnReset_trigger").on("click", function() {
                that.resetValue();
            });
        }
    }
    ...
    resetValue(newPlaceholder) {
        ...
        parent.find("._dc_customSelect__btnReset_trigger").on("click", function() {
            ...
            parent.find("._dc_customSelect__list_item.active").removeClass("active");
        });
    }
