/*
  Иногда бывает такое, что при изменение размера окна необходимо менять и сам класс 
  или при загрузке странице на после определенного разрешие нужно поменять класс.
*/
